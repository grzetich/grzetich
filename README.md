...
**Selected work:**
- [_Tokens Not Jokin'_](https://tokensnotjokin.com) (Leanpub, 2026), a study of over 21,000 controlled integration tests showing that documentation format explains more variance in AI code generation quality than the choice of model.
...
**Also building:** [not-claw](https://github.com/grzetich/not-claw), an autonomous agent that uses a Notion MCP server as its backend, and command-line tools that probe and score API docs for AI readiness.
